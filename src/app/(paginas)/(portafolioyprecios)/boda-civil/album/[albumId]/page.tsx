...
const PageAlbumId = async ({ params, searchParams }: Props) => {
	...
	return (
		<>
			<PhotoAlbum originGalleryUrl={PortfolioAndPricingEndpoints.boda_civil.pathForLink} AlbumInformation={pgdt as TypeGenerateImagesInAlbum} image={searchParams.image} />
		</>
	)
}
