...
export const PhotoAlbumPageFrame = ({ data, children }: Props) => {
	return (
		<>
			...
			>
				<div className={`flex justify-center h-[82.5vh] md:h-auto md:w-screen items-center aspect-[16/9] absolute bg-agatha-black`}>
					<Image
				...
				<div className={`bg-transparent z-10 relative`}>
					...
					>
						...
						<div className='flex flex-col sm:mt-[0.5rem] xl:mt-[1rem] sm:flex-row sm:justify-start md:justify-center items-start sm:items-center w-full gap-[0.75rem] '>
							<h3 className={`leading-[1.5rem] font-light text-[0.8rem] text-start w-full sm:w-[10%] sm:min-w-[6.5rem] md:min-w-[15.5rem] md:text-end  px-[0.625rem]`}>{`${data.amountOfPhotos} FOTOS`}</h3>
						...
						<div className=' text-[3.35rem] font-mono leading-[1.5rem] font-extralight w-full md:text-center text-start'>~</div>
						<h2
