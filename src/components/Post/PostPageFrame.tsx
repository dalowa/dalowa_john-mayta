...
const PostPageFrame = ({ data, children }: Props) => {
	return (
		<>
			<main
			...
			>
				...
				<div className={`bg-transparent z-10 relative`}>
					<header
						className={`w-full py-[3.9rem] gap-[1.25rem] lg:gap-[1.5rem] xl:gap-[1.25rem] min-h-[12rem] flex flex-col justify-center items-center | lg:min-h-[18.25rem]`}
					>
						<h1
							className={`tracking-[0.25rem] text-agatha-text-a font-thin text-center leading-[1.2] text-[1.75rem] md:text-[1.75rem] w-[95%] lg:text-[2.6rem]`}
						>{`${data.title}`}</h1>
						<h2
